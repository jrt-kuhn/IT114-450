...
public class Room implements AutoCloseable{
	...
	public void close() {
        ...
        private final static String ITALICS = "'";
        private final static String COLOR_RED = "?";
        private final static String COLOR_BLUE = "!";
        private final static String COLOR_GREEN = "&";
        private final static String UNDERLINE = "__"; //2 underscores
        public void styleCheck(String message){
           // String[] sty = message.split([0]);
           // if (message > 2)
            //switch ()
        }
}